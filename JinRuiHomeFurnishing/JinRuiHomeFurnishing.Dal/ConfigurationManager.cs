...
namespace JinRuiHomeFurnishing.Dal
{
    public class ConfigurationManager
    {
        ...
        /// <summary>
        /// 默认路径Directory.GetCurrentDirectory()为.netcore运行路径
        /// </summary>
        private static string _defaultPath = Path.Combine(Directory.GetCurrentDirectory(), "appsettings.json");
        ...
        /// 配置节点关键字
        /// </summary>
        private static string _configSection = "ConnectionStrings";
